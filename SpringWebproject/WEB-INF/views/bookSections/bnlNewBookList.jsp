			...
			<div class="conWrap">
				...
				<div class="side_t2 ml5">
					<div class="cate_comm">
						...
						<ul class="cate_d1">
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1" class="cate_d1_link">종합</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=1&sort2nd=90" class="cate_d1_link">소설</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=91&sort2nd=114" class="cate_d1_link" class="cate_d1_link">장르소설</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=115&sort2nd=174" class="cate_d1_link">시/에세이/기행</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=292&sort2nd=380" class="cate_d1_link" class="cate_d1_link">인문/교양/철학</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=381&sort2nd=430" class="cate_d1_link" class="cate_d1_link">역사/신화/문화</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=431&sort2nd=473" class="cate_d1_link" class="cate_d1_link">종교</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=474&sort2nd=527" class="cate_d1_link" class="cate_d1_link">사회/정치/법률</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=197&sort2nd=254" class="cate_d1_link" class="cate_d1_link">경제/경영</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=255&sort2nd=291" class="cate_d1_link">자기계발</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=943&sort2nd=1012" class="cate_d1_link" class="cate_d1_link">외국어/사전</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=1275&sort2nd=1316" class="cate_d1_link" class="cate_d1_link">가정/생활/요리</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=1317&sort2nd=1362" class="cate_d1_link" class="cate_d1_link">건강/의학/미용</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=667&sort2nd=703" class="cate_d1_link" class="cate_d1_link">유아</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=704&sort2nd=773" class="cate_d1_link" class="cate_d1_link">어린이</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=175&sort2nd=196" class="cate_d1_link" class="cate_d1_link">청소년교양</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=528&sort2nd=666" class="cate_d1_link" class="cate_d1_link">예술/대중문화</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=1363&sort2nd=1419" class="cate_d1_link" class="cate_d1_link">여행/취미/레저</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=1420&sort2nd=1439" class="cate_d1_link" class="cate_d1_link">잡지</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=1440&sort2nd=1468" class="cate_d1_link" class="cate_d1_link">만화</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=1153&sort2nd=1274" class="cate_d1_link" class="cate_d1_link">컴퓨터/IT</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=607&sort2nd=609" class="cate_d1_link" class="cate_d1_link">자연과학/공학</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=1013&sort2nd=1152" class="cate_d1_link" class="cate_d1_link">대학교재</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=774&sort2nd=796" class="cate_d1_link" class="cate_d1_link">아동전집</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=1469&sort2nd=1518" class="cate_d1_link" class="cate_d1_link">서양서</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=798&sort2nd=839" class="cate_d1_link" class="cate_d1_link">초등참고서</a></li>
							<li class="cate_d1_li "><a href="<%=cp%>/bnlNewBookList.action?pageNum=1&sort1st=840&sort2nd=942" class="cate_d1_link" class="cate_d1_link">중/고등참고서</a></li>
						</ul>
					</div>
				</div>

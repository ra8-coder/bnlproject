					...
					<p>
						<table cellspacing="0" cellpadding="0" class="table_t_line">
						  <tr>
						    ...
						    <th width="255" bgcolor="#efefef"><strong>선택항목</strong></th>
						    <th width="255" bgcolor="#efefef"><strong>목적</strong></th>
						    <th width="100" bgcolor="#efefef"><strong>보유 및 이용기간</strong></th>
						  </tr>
						  <tr>
						    <td rowspan="3" style="border-left: none;">일반</td>
						    <td>주소(자택 or 직장)</td>
						    <td>상품 배송, 경품 배송</td>
						    <td rowspan="11">회원탈퇴시<br>또는<br>(제 6항에 관계법령에 따름)</td>
						  </tr>
						  <tr>
						  	<td style="border-left:1px solid #d8d8d8">환불계좌정보(은행명, 계좌번호, 예금주명)</td>
						  	<td>환불 처리</td>
						  </tr>
						  <tr>
						  	<td style="border-left:1px solid #d8d8d8">관심분야, 닉네임, 직업, 취미</td>
						  	<td>회원 맞춤 서비스</td>
						  </tr>			  
						</table>
					</p>					

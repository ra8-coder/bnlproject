...
<body>
	...
	<div id="side_service" style="margin-left: 575px;">
		...
		<div class="ss_myshop">
			<a href="<%=cp%>/myShoppingMain.action"> 나의 쇼핑 </a>
		</div>
		<div class="ss_myshop">
		...
		<div class="wrap_header">
			<div class="header_menu" style="width: 1100px;">
				<ul class="menu_wrap">
					<li class="menu"><a href="javascript://"
						...
						<div id="layer01" class="display_wrap display_total"
							...
							<div class="cate01">
								...
								<ul class="cate_list">
									<li><a href="<%=cp%>/book_novel.action"> <em>소설</em>
									</a></li>
									<li><a href="<%=cp%>/genre_fiction.action"> <em>장르소설</em>
									</a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=115">
											시/에세이/기행 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=175">
											청소년교양 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=197">
											경제/경영 </a></li>
									<li><a href="<%=cp%>/book_self_improvement.action"> <em>자기계발</em>
									</a></li>
								</ul>
								<ul class="cate_list">
									<li><a href="<%=cp%>/book_cate.action?categoryId=667">
											유아 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=692">
											육아/자녀교육 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=704">
											어린이 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=767">
											어린이 영어 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=774">
											아동전집 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=794">
											정가제 Free </a></li>
								</ul>
								<ul class="cate_list">
									<li><a href="<%=cp%>/book_cate.action?categoryId=1275">
											가정/생활/요리 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=1317">
											건강/의학/미용 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=1363">
											여행/취미/레저 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=1420">
											잡지 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=1440">
											만화 </a></li>
								</ul>
								<ul class="cate_list clear">
									<li><a href="<%=cp%>/book_cate.action?categoryId=292">
											인문/교양/철학 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=381">
											역사/신화/문화 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=431">
											종교 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=474">
											사회/정치/법률 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=528">
											예술/대중문화 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=607">
											자연과학/공학 </a></li>
								</ul>
								<ul class="cate_list">
									<li><a href="<%=cp%>/book_cate.action?categoryId=798">
											초등학습 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=840">
											중/고등참고서 </a></li>
									<li>&nbsp;</li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=943">
											외국어/사전 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=1013">
											대학교재 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=1153">
											컴퓨터/IT </a></li>
								</ul>
								<ul class="cate_list">
									<li><a href="<%=cp%>/book_cate.action?categoryId=1469">
											서양서 </a></li>
									<li><a href="<%=cp%>/book_cate.action?categoryId=1487">
											일본서 </a></li>
								</ul>
							</div>
							<div class="cate02">
					...
					<li class="menu"><a href="<%=cp%>/bnlBSList.action"
						class="menu_link menu_best"> <span></span>
					</a></li>
					<li class="menu"><a href="<%=cp%>/bnlNewBookList.action"
						class="menu_link menu_new"> <span></span>
					</a></li>
					<li class="menu"><a href="<%=cp%>/discountBookMain.action"

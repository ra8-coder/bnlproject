...
public class MyUtil {
	...
	public String pageIndexList(int currentPage, int totalPage, String listUrl) {
		...
		while (page <= totalPage && page <= (currentPageSetup + numPerBlock)) {
			...
			if (page == currentPage) {
				...
				sb.append("<span class='page_off'><a href=\"" + listUrl + "pageNum=" + page + "\">" + page
						+ "</a></span>&nbsp;");
	...
	public String pageIndexListforJ(int currentPage, int totalPage, String listUrl) {
		...
		while (page <= totalPage && page <= (currentPageSetup + numPerBlock)) {
			...
			if (page == currentPage) {
				...
				sb.append("<a href=\"" + listUrl + "pageNum=" + page + "#tabMenu\">" + page + "</a>&nbsp;");
	...
	public String pageIndexListforDiscount(int currentPage, int totalPage, String listUrl, int categoryId) {
		...
		while (page <= totalPage && page <= (currentPageSetup + numPerBlock)) {
			...
			if (page == currentPage) {
				...
				sb.append("<a class='on' style = 'color : #947555'>" + page + "</a>&nbsp;");

			} else {

				sb.append("<a href=\"" + listUrl + "pageNum=" + page + "&categoryId=" + categoryId
						+ "#menu_discount\" style = 'color : #947555'>" + page + "</a>&nbsp;");
